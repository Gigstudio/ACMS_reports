...
$loader->addNamespace(APPLICATION . '\System\Engine\Exceptions',	PATH_ENGINE);
$loader->addNamespace(APPLICATION . '\System\Engine\Modules',		PATH_MODULES);
$loader->addNamespace(APPLICATION . '\System\Http', 				PATH_HTTP);
$loader->addNamespace(APPLICATION . '\System\Network', 				PATH_NETWORK);
